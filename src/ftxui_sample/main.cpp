...
// configuration step. It creates a namespace called `TBD`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", TBD::cmake::project_name, TBD::cmake::project_version) };
